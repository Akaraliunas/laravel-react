...
export default function Welcome({ auth, flash_message, products, wishlistedProducts, searchKeyword }) {
    ...
    const isActiveHeart = (id) => {
        return wishlistedProducts && wishlistedProducts.data &&wishlistedProducts.data.findIndex((product) => product.product_id == id) != -1
    };

    return (
        <>
            <Head title="Welcome" />
            <div className="relative min-h-screen pt-10 bg-gray-100 bg-center sm:flex sm:justify-center sm:items-start bg-dots-darker dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="w-full p-6 mx-auto max-w-7xl lg:p-8">
